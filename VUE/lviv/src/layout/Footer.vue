  ...
  <footer class="footer">
    <div class="container-fluid">
      <div class="copyright">
        ...
        <a href="#" target="_blank" rel="noopener">AAA</a>&nbsp;&
        <a href="#" target="_blank" rel="noopener">SSS</a>
        for a better web.
      </div>
    </div>
    <a href="#content" class="top-of-site-link">
      <!-- <span class="screen-reader-text">Back to Top</span> -->
      <svg class="icon" width="32" height="32" viewBox="0 0 100 100">
        <path
          fill="white"
